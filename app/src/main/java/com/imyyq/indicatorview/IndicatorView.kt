...
class IndicatorView : View {
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        arr?.let {
            ...
            mSelectedColor =
                it.getColor(R.styleable.IndicatorView_indicatorSelectedColor, mSelectedColor)
            ...
            mCornerRadius =
                it.getDimension(R.styleable.IndicatorView_indicatorCornerRadius, mCornerRadius)
        }
        arr?.recycle()
